...
<html lang="pt-br">
    <head>
        <title>Auditoria em Execucao</title>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-5">
                    <div class="input-group-prepend">
                        ...
                        <select class="form-control" method='get' type="submit" id="fitroCampanha" onChange="emExecucao(1)">
                ...
                <div class="col-6 col-md-5">
                    <div class="input-group-prepend">
                        ...
                        <select class="form-control" method='get' type="submit" id="filtroSupervisor" onChange="emExecucao(1)">
                            <option value="">SELECIONE:</option>
