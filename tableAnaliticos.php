...
<html lang="pt-br">
    <head>
        ...
        <script>
            ...
            function emTransito(id){
                var stop = id;
                var tabela = '#dadosTabelaEmTransito';
                var banco = '../sql/sqlAuditoriaEmTransito.php'
                var dados = 'campanha='+document.getElementById('fitroCampanhaEmTransito').value+'&supervisor='+document.getElementById('filtroSupervisorEmTransito').value;
                if(stop==1)
                {
                    clearInterval(temp2);
            ...
            var temp3;
            var timer3;
            function emExecucao(id){
                var stop = id;
                var tabela = '#dadosTabelaEmExecucao';
                var banco = '../sql/sqlAuditoriaEmExecucao.php'
                var dados = 'campanha='+document.getElementById('fitroCampanhaEmExecucao').value+'&supervisor='+document.getElementById('filtroSupervisorEmExecucao').value;
                if(stop==1)
                {
                    clearInterval(temp3);
                ...
                temp3 = setInterval(() => {
                    var TotalId = '#TotalEmExecucao';
                    var TotalBanco = '../sql/sqlTotalEmExecucao.php';
                    var totalDados = dados+'&solic=1';
                    ajaxTempos(TotalId,TotalBanco,totalDados);
                }, 1000);
            }
    ...
    <body onload="filaAuditoria(0)">
        <?php include '../nav/navbarAnaliticos.php'; ?>
    <div data-spy="scroll" data-target="#navbar-analiticos" data-offset="0">
        <div class="container-fluid" id="FilaAuditoria">
        ...
        <div class="container-fluid" id="EmTransito">
            <main role="main" class="container">
                <div class="starter-template">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="Campanha">Campanha:</span>
                            <select class="form-control" method='get' type="submit" id="fitroCampanhaEmTransito" onChange="emTransito(1)">
                                <option value="">SELECIONE:</option>
                                <option value="CLARO_TV">CLARO TV</option>
                                <option value="COMBO_MULTI">COMBO MULTI</option>
                                <option value="NOVO_COMBO_MULTI">NOVO COMBO MULTI</option>
                    ...
                    <div class="col-6 col-md-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="Campanha">Supervisor:</span>
                            <select class="form-control" method='get' type="submit" id="filtroSupervisorEmTransito" onChange="emTransito(1)">
                                <option value="">SELECIONE:</option>
                                <?php include '../sql/sqlListaSupervisor.php'; ?>
                            </select>
                        </div>
            ...
            <div>
                <div class="table-responsive">
                    <table class="table table-striped table-sm" name="tabela" id="tabela" metod="get">
                        ...
                        <tbody id="dadosTabelaEmTransito"></tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="container-fluid" id="EmExecucao">
            <main role="main" class="container">
                <div class="starter-template">
                    <h1>Auditoria em Execucao</h1>
                </div>
                <div class="row">
                    <div class="col-6 col-md-2">
                        <div class="input-group-prepend">
                    ...
                    <div class="col-6 col-md-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="Campanha">Campanha:</span>
                            <select class="form-control" method='get' type="submit" id="fitroCampanhaEmExecucao" onChange="emExecucao(1)">
                                <option value="">SELECIONE:</option>
                                <option value="CLARO_TV">CLARO TV</option>
                                <option value="COMBO_MULTI">COMBO MULTI</option>
                                <option value="NOVO_COMBO_MULTI">NOVO COMBO MULTI</option>
                    ...
                    <div class="col-6 col-md-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="Campanha">Supervisor:</span>
                            <select class="form-control" method='get' type="submit" id="filtroSupervisorEmExecucao" onChange="emExecucao(1)">
                                <option value="">SELECIONE:</option>
                                <?php include '../sql/sqlListaSupervisor.php'; ?>
                            </select>
                        </div>
            ...
            <div>
                <div class="table-responsive">
                    <table class="table table-striped table-sm" name="tabela" id="tabela" metod="get">
                        ...
                        <tbody id="dadosTabelaEmExecucao"></tbody>
                    </table>
                </div>
            </div>
            <footer class="text-muted">
